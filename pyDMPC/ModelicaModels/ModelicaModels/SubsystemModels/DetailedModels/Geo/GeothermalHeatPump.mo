...
model GeothermalHeatPump "Example of a geothermal heat pump system"
  ...
  AixLib.Fluid.Sources.Boundary_pT heatConsumerFlow(redeclare package Medium =
        Water, nPorts=1) "Sink representing heat consumer" annotation (
...
equation
  ...
  connect(pressureDifference.y, pumpColdConsumer.dp_in) annotation (Line(points={{81.4,18},
          {65,18},{65,-11.6}},                       color={0,0,127}));
  connect(pressureDifference.y, pumpHeatConsumer.dp_in) annotation (Line(points={{81.4,18},
          {56,18},{56,-36},{65,-36},{65,-41.6}},                       color={0,
          0,127}));
  ...
  connect(pressureDifference.y, pumpEvaporator.dp_in) annotation (Line(points={{81.4,18},
          {56,18},{56,54},{7,54},{7,44.4}},                       color={0,0,
          127}));
  connect(pressureDifference.y, pumpCondenser.dp_in) annotation (Line(points={{81.4,18},
          {56,18},{56,-36},{-1,-36},{-1,-89.6}},              color={0,0,127}));
  connect(pumpGeothermalSource.dp_in,pressureDifference. y) annotation (Line(
        points={{-89,-45.6},{-89,-36},{56,-36},{56,18},{81.4,18}},     color={0,
          0,127}));
  ...
  connect(getTStorageUpper.y, hPControllerOnOff.T_set) annotation (Line(points={{-139,74},
          {-139,68},{-116,68},{-78,68}},            color={0,0,127}));
  ...
  connect(PeakLoadDevice.chemicalEnergyFlowRate, chemicalEnergyFlowRate)
    annotation (Line(points={{112.77,-56.54},{112.77,-118},{-26,-118},{-26,-100},
          {-61.5,-100},{-61.5,-119.5}}, color={0,0,127}));
  ...
  connect(getTStorageUpper.y,geothermalFieldControllerHeat. temperature)
    annotation (Line(points={{-139,74},{-120,74},{-120,-26},{-100,-26}}, color=
          {0,0,127}));
