...
equation
  connect(variation.y[1], boundary.T_in) annotation (Line(points={{-79,90},{-60,
          90},{-60,54},{-86,54},{-86,36},{-78,36}},
                                                  color={0,0,127}));
  connect(product1.y, prescribedHeatFlow.Q_flow) annotation (Line(points={{-13,-56},
          {0,-56},{0,20},{-34,20},{-34,42},{-18,42}},      color={0,0,127}));
