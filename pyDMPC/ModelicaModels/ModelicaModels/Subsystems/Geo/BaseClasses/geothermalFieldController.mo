...
//     "true = hysteresis with negation = for warm side";
     ...
     parameter Modelica.SIunits.Temperature bandwidth=2
       "Time delay between opening of valve 1 and 2";
  ...
  Modelica.Blocks.Logical.OnOffController OnOffController(bandwidth=bandwidth)
    "Checks if the temperature is too high or too low"
  ...
  Modelica.Blocks.Interfaces.RealInput Setpoint
    ...
    annotation (Placement(transformation(extent={{-114,56},{-86,84}})));
equation
  ...
  connect(switch.y, add.u1) annotation (Line(points={{-15.4,0},{-15.4,0},{-8,0},
          {-8,-40.6},{-3.4,-40.6}},
                  color={0,0,127}));
  connect(OnOffController.y, switch.u2) annotation (Line(points={{-65.4,0},{-65.4,
          0},{-29.2,0}}, color={255,0,255}));
  connect(temperature, OnOffController.u) annotation (Line(points={{-100,0},{-90,
          0},{-90,-3.6},{-79.2,-3.6}}, color={0,0,127}));
  ...
  connect(OnOffController.y, switch1.u2) annotation (Line(points={{-65.4,0},{-64,
          0},{-64,2},{-64,40},{54.8,40}}, color={255,0,255}));
  connect(OnOffController.y, switch2.u2) annotation (Line(points={{-65.4,0},{-64,
          0},{-64,-6},{-64,-60},{44,-60},{44,-40},{58.8,-40}}, color={255,0,255}));
  ...
  connect(OnOffController.reference, Setpoint) annotation (Line(points={{-79.2,3.6},
          {-80,3.6},{-80,70},{-100,70}}, color={0,0,127}));
