...
state_factors = [None for _ in range(n)]
state_offsets = [None for _ in range(n)]
input_factors = [None for _ in range(n)]
input_offsets = [None for _ in range(n)]
output_factors = [None for _ in range(n)]
output_offsets = [None for _ in range(n)]
...
sys_id[0] = 0
name[0] = "Heater"
model_type[0] = "Statespace"
ups_neigh[0] = 1
input_names[0] = ["heaterTemperature.T"]
input_variables[0] = [r"variation.table[1, 2]"]
inputs[0] = [i for i in range(288, 325, 1)]
output_names[0] = ["heater.returnTemperature"]
set_points[0] = [303]
state_var_names[0] = ["heater.waterInflowTemperature"]
model_state_var_names[0] = ["mas1.k", "mas1.k"]
start[0] = 0.
stop[0] = 3600
incr[0] = 10.
opt_time[0] = 600
...
mod_path[0] = f'{glob_res_path}\\model_ah_s2'
command_names[0] = ["valveHeater"]
command_variables[0] = ["decisionVariables.table[1, 2]"]
commands[0] = [[i] for i in range(0, 100, 5)]
traj_points[0] = []
traj_var[0] = []
cost_fac[0] = [0.1, 0.0, 1.0]
state_offsets[0] = [-283.15, -283.15]
state_factors[0] = [1, 1]
input_offsets[0] = [-273.15]
input_factors[0] = [1]
output_offsets[0] = [-273.15]
output_factors[0] = [1]
...
inputs[1] = [i for i in range(288, 325, 1)]
set_points[1] = [303]
